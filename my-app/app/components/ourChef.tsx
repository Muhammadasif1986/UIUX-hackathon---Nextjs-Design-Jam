...
export default function OurChef() {
  return (
    ...
    <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center h-auto lg:h-[200px] mt-8">
          <div className='relative -ml-96 rotate-6'><Image src="/bg.png" alt="Image" width={300} height={300} /></div>
